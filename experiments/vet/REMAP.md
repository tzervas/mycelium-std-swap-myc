# Remap Manifest — mycelium-std-swap → std.swap
...
|---|---|---|---|---|---|---|
| `std.swap` | Keep | Safe | false | true | `/root/git/isolated/mycelium/crates/mycelium-std-swap/src/lib.rs` | structure-preserving 1:1 (DN-109 §5.3-B v0 default: every emitted nodule keeps its source file's mod-tree position, no restructuring proposed) |
